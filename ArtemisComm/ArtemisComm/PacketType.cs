...
namespace ArtemisComm
{
    public enum PacketType : int
    {
        ...
        //Server to Client
        CommsIncomingPacket = -697121953, //0xd672c35f,  //- 697121953, //3597845343, //0xd672c35f,
        DestroyObjectPacket = -866501072, //0xcc5a3e30, //-866501072, //3428466224, //0xcc5a3e30,
        EngGridUpdatePacket = 0x077e9f3c, //125738812, //0x077e9f3c,

        IncomingAudioPacket = -1366761384, //0xae88e058, //-1366761384, //2928205912, //0xae88e058,
        //AllShipSettingsPacket = 0xf754c8fe, // - 145438466, //f754c8fe
        GameMessagePacket = -145438466, //0xf754c8fe, //-145438466, //4149528830, //0xf754c8fe,
        ObjectStatusUpdatePacket = -2139079175, //0x80803df9, // -2139079175, //2155888121, //0x80803df9,
        StationStatusPacket = 0x19c6e2d4, // 432464596, //0x19c6e2d4,

        VersionPacket = -448207030, //0xe548e74a, //-448207030, //3846760266, //0xe548e74a,
        WelcomePacket = 0x6d04b3da, //1829024730, //0x6d04b3da,
        GameStartPacket = 0x3de66711, //1038509841, //0x3de66711, 
        Unknown2Packet = -176025050, //0xf5821226, //-176025050, //4118942246, //-176025050, //0xf5821226,

        IntelPacket = -295284103, //0xee665279,
        //Client to Server
        ...
        BeamFiredPacket = -1203776828, //0xb83fd2c4
